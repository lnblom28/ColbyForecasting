...
```{r sample_background}
obsbkg = sample_background(wicked_thinned_aug_obs, mask, nrow(wicked_thinned_aug_obs),
                           return_pres = TRUE) |>
...
make_model_input_by_month  = function(mon = "Jan",
  ...
  model_input = sample_background(thinned, raster, nrow(thinned),
                                   return_pres = TRUE) |>
    mutate(month = "Aug", .before = 1)
  # save the data
